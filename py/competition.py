...
def generer_fichiers_soumission(positions, theta, W, nom_base):
    ...
    print(
        f"Fichiers motifs-{nom_base}.txt et pwm-{nom_base}.txt générés avec succès !"
    )
