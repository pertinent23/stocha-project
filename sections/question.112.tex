...
On remaque que peu importe la condition initiale, les probabilités convergent vers le même ordre
$P(C) > P(A) > P(G) > P(T)$. Cependant quand la distribution initiale est uniforme on a plus d'écart
de chance à long terme que lorsqu'au départ on a un C.
